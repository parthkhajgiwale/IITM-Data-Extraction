...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost','192.168.1.8','192.168.1.2','192.168.168.88','172.20.10.7']
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'andrew.fleck.65@gmail.com'
EMAIL_HOST_PASSWORD = 'Hare Krsna'
